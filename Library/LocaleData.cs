    ...
    public abstract class LocaleData {
        ...
        protected Dictionary<string, string> msgFallback 
            = new Dictionary<string, string>() {
                ...
                ["GuiMenuActFanModeEco"] = "Eco (Quiet)",
                ["GuiMenuActFanModeBalance"] = "Balance (Normal)",
                ["GuiMenuActFanModeNormal"] = "Normal",
                ["GuiMenuActFanModeTurbo"] = "Turbo",
                ...
                ["GuiMenuActGpuModeHybrid"] = "Hybrid Graphics",
                ...
                ["GuiTipFanAutoVictus"] = "Firmware automatic cooling. Manual control may persist for about two minutes on AC or ten minutes or longer on battery. The countdown estimates the wait and may reach zero before firmware takes over; keyboard changes restart it.",
                ...
                ["GuiTipTmpCPU"] = "CPU firmware temperature (EC); may differ from package temperature in Gaming Hub",
                ["GuiTipTmpGPU"] = "GPU firmware temperature (EC); may differ from the driver reading in Gaming Hub",
                ["GuiTipTmpSYS"] = "System thermal sensor (EST2); not an identified SSD sensor",
                ["GuiTipTmpSSD"] = "Custom storage sensor",
                ["GuiTipTmpRTMP"] = "RTMP",
                ["GuiTipTmpTMP1"] = "TMP1",
